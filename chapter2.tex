...
ラウンド$t$における相手が送信した提案で人間が得られる推定効用を$U_H(bid_t)$，相手が送信した過去の提案で人間が得られる推定効用の平均を$\mu$，
...
また，\figref{fig:koley_result}のように合意案のほとんどがパレートフロント近辺であり，さらに最適でかつ公平な解である(0.7, 0.7)の近辺が最も多かった．
\begin{figure}[htb]
    \centering
    \includegraphics[width=10truecm]{image/neg_result.eps}
