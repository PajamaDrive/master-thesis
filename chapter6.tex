...
\figref{fig:util}のように，すべての手法においてエージェントの効用の平均は人間の効用の平均より高い値となっている．
...
\subsection{パレート最適性}
各セッションにおけるエージェントと人間の効用をを2次元座標にプロットしたものを\figref{fig:scatter}に示す．
...
\figref{fig:scatter}のように，すべての手法において合意案のほとんどはパレート最適性を満たすような合意案であった．
